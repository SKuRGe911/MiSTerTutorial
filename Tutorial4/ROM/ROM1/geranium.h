...
#define GERANIUM_IRQ_VIDEO_SWAP						0x01000000
#define GERANIUM_IRQ_KEYBOARD_INPUT					0x02000000
#define GERANIUM_IRQ_HARDWARE_ACK					0x04000000
...
#define WRITECHAR_CLEAR_LINNE()						(*(volatile uint32_t*)GERANIUM_IO_ADDRESS) = (0x040000000)
#define WRITECHAR_CONSOLE_ON()						(*(volatile uint32_t*)GERANIUM_IO_ADDRESS) = (0x020000000)
#define WRITECHAR_CONSOLE_OFF()						(*(volatile uint32_t*)GERANIUM_IO_ADDRESS) = (0x008000000)
